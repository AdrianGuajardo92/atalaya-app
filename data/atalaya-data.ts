...
export const atalayaDatabase: AtalayaDatabase = {
  ...
  "2025-09": {
    articles: [
      // Artículo 35: "Cómo ganar la batalla contra los malos deseos" (4-10 Nov)
      {
        metadata: {
          articleNumber: 35,
          week: "4-10 Nov",
        ...
        questions: [
          ...
          {
            number: "2",
            textEs: "¿Qué tentaciones quizás estén enfrentando algunos cristianos y estudiantes de la Biblia? (Vea también las imágenes).",
            textLSM: "",
            paragraphs: [2]
          },
          {
          ...
          {
            number: "8",
            textEs: "¿Qué otra cosa nos puede hacer creer que no tenemos la aprobación de Dios o las fuerzas para resistir los malos deseos? (Salmo 51:5; vea también la \"Idea importante\").",
            textLSM: "",
            paragraphs: [8],
            section: "CÓMO NOS PUEDE HACER SENTIR EL PECADO HEREDADO"
          },
          {
            number: "9, 10",
            textEs: "a) ¿Cómo se sintieron Adán y Eva cuando se convirtieron en seres imperfectos? (Vea también la imagen). b) ¿Cómo nos sentimos nosotros debido a la imperfección?",
            textLSM: "",
            paragraphs: [9, 10]
          },
          {
          ...
          {
            number: "17",
            textEs: "¿Qué aprendemos de José? (Génesis 39:7-9; vea también las imágenes).",
            textLSM: "",
            paragraphs: [17]
          },
          {
            number: "18",
            textEs: "¿Qué más puede hacer para ganar su batalla contra los malos deseos? (2 Corintios 13:5).",
            textLSM: "",
            paragraphs: [18],
            section: "\"SIGAN EXAMINÁNDOSE\""
          },
