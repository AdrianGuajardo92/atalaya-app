...
export const biblicalTexts20260629: Record<string, { reference: string; text: string }[]> = {
  ...
  "Génesis 2:16": [
    {
      "reference": "Génesis 2:16",
      "text": "Puedes comer de todos los árboles del jardín hasta quedar satisfecho."
    }
  ],
  "Génesis 2:17": [
    {
      "reference": "Génesis 2:17",
      "text": "Pero no debes comer del árbol del conocimiento de lo bueno y lo malo, porque el día en que comas de él sin falta morirás."
    }
  ],
  "Génesis 3:6": [
    {
  ...
  "Efesios 5:28": [
    {
      "reference": "Efesios 5:28",
      "text": "Del mismo modo, los esposos deben amar a sus esposas como a sus propios cuerpos. El hombre que ama a su esposa se ama a sí mismo,"
    }
  ],
  "Efesios 5:29": [
    {
      "reference": "Efesios 5:29",
      "text": "porque nadie ha odiado jamás su propio cuerpo, sino que lo alimenta y lo cuida con cariño, tal como el Cristo hace con la congregación,"
    }
  ],
  "Efesios 5:33": [
    {
      "reference": "Efesios 5:33",
...
export const study20260629: ArticleData = {
  ...
  "song": "Canción 131 “Lo que Dios ha unido”",
  "title": "Sigan fortaleciendo su amistad como matrimonio",
  "biblicalText": "“Hay un amigo que se apega más que un hermano” (PROV. 18:24).",
  "theme": "Para tener un matrimonio feliz, el esposo y la esposa deben ser muy amigos y amar a Jehová.",
  "questions": [
    {
      "number": "1",
      ...
      "keyPoint": "LOS buenos amigos son un regalo de Jehová (Sant. 1:17).",
      "answers": [
        {
      ...
      "guidingQuestion": "¿Qué cualidades hacen valiosos a los buenos amigos?",
      "commentSuggestion": "Yo podría comentar que los buenos amigos no son un lujo, sino un regalo de Jehová que nos ayuda en la vida y también en el matrimonio."
    },
    {
      "number": "2",
      ...
      "guidingQuestion": "¿Qué pasa si descuidamos la amistad en el matrimonio?",
      "commentSuggestion": "Yo podría comentar que fortalecer la amistad en el matrimonio protege la relación y evita sentirse solos o frustrados."
    },
    {
      "number": "3, 4",
      ...
      "keyPoint": "Él quiere que encontremos un buen esposo o esposa y siempre sabe lo que es mejor para nosotros (lea Proverbios 18:22; Is. 48:17, 18).",
      "answers": [
        {
      ...
      "section": "CÓMO ELEGIR UN AMIGO PARA TODA LA VIDA",
      "readText": "LEE Proverbios 18:22",
      "biblicalCards": [
        {
          "reference": "Proverbios 18:22",
      ...
      "commentSuggestion": "Yo podría comentar que elegir pareja es una de las decisiones más importantes, por eso debemos seguir los principios de Jehová."
    },
    {
      "number": "5",
      ...
      "keyPoint": "Cuando nos bautizamos, llegamos a ser amigos de Dios (Sal. 25:14).",
      "answers": [
        {
      ...
      "guidingQuestion": "¿Por qué no conviene salir con alguien que no es Testigo?",
      "commentSuggestion": "Yo podría comentar que casarse 'en el Señor' protege la unidad espiritual y evita muchos problemas futuros."
    },
    {
      "number": "6, 7",
      ...
      "guidingQuestion": "¿Qué preguntas prácticas ayudan a conocer de verdad a la persona?",
      "commentSuggestion": "Yo podría comentar que no basta con que alguien sea bautizado; hay que observar su carácter y metas espirituales."
    },
    {
      "number": "8, 9",
      ...
      "keyPoint": "Eso lo ayudará a decidir si debe casarse o no con la persona.",
      "answers": [
        {
      ...
      "image": "https://cms-imgp.jw-cdn.org/img/p/2026368/univ/art/2026368_univ_cnt_1_xl.jpg",
      "imageCaption": "Durante el noviazgo, trate de averiguar cómo es en realidad la persona. (Vea los párrafos 8 y 9).",
      "guidingQuestion": "¿Cómo puede el noviazgo revelar la verdadera personalidad de alguien?",
      "commentSuggestion": "Yo podría comentar que conviene escuchar a personas maduras y no ignorar dudas serias durante el noviazgo."
    },
    {
      "number": "10",
      ...
      "keyPoint": "El esposo y la esposa fortalecen su amistad y su matrimonio sacando tiempo para estar juntos aunque estén muy ocupados.",
      "answers": [
        {
      ...
      "guidingQuestion": "¿Por qué el tiempo juntos fortalece la amistad conyugal?",
      "commentSuggestion": "Yo podría comentar que aunque estemos ocupados, necesitamos tiempo de calidad para hablar y disfrutar juntos."
    },
    {
      "number": "11",
      ...
      "keyPoint": "Si el esposo y la esposa son buenos amigos, preferirán estar juntos y no separados.",
      "answers": [
        {
      ...
      "commentSuggestion": "Yo podría comentar que la distancia prolongada puede debilitar la amistad, aunque a veces parezca una solución práctica."
    },
    {
      "number": "12, 13",
      ...
      "keyPoint": "Veamos lo que han hecho algunos matrimonios para asegurarse de pasar tiempo juntos con regularidad.",
      "answers": [
        {
      ...
      "image": "https://cms-imgp.jw-cdn.org/img/p/2026368/univ/art/2026368_univ_cnt_2_xl.jpg",
      ...
      "guidingQuestion": "¿Qué han hecho algunos matrimonios para pasar tiempo juntos?",
      "commentSuggestion": "Yo podría comentar que algunos matrimonios programan tiempo juntos y también lo dedican a actividades espirituales."
    },
    {
      "number": "14, 15",
      ...
      "keyPoint": "Cuando aparecen esos problemas, el esposo y la esposa deben esforzarse por permanecer unidos y resolverlos.",
      "answers": [
        {
      ...
      "section": "PERMANEZCAN UNIDOS A PESAR DE LOS PROBLEMAS",
      "biblicalCards": [
        {
          "reference": "1 Corintios 7:28",
      ...
      "guidingQuestion": "¿Por qué vale la pena restaurar un matrimonio con problemas?",
      "commentSuggestion": "Yo podría comentar que los problemas no significan que el matrimonio deba terminar; con empeño puede restaurarse."
    },
    {
      "number": "16",
      ...
      "keyPoint": "Si surgen problemas en su matrimonio, no se apresure a separarse de su pareja (1 Cor. 7:10, 11).",
      "answers": [
        {
      ...
      "guidingQuestion": "¿Qué cualidades del amor en 1 Corintios 13 pueden ayudar?",
      "commentSuggestion": "Yo podría comentar que el amor descrito en 1 Corintios 13 ayuda a reparar la relación en lugar de buscar la separación.",
      "readText": "LEE 1 Corintios 13:4-8"
    },
    {
      "number": "17",
      ...
      "keyPoint": "Jehová desea que todos sus siervos sean felices, incluidos quienes están pensando en casarse y quienes ya están casados.",
      "answers": [
        {
      ...
      "guidingQuestion": "¿Qué consejo final da el artículo a solteros y casados?",
      "commentSuggestion": "Yo podría comentar que Jehová quiere que seamos felices, ya sea escogiendo bien la pareja o fortaleciendo el matrimonio actual."
    }
  ],
  "paragraphs": [
    {
    ...
    },
    {
      ...
      "sidebar": {
        ...
        "intro": "Hay muchas amistades importantes en nuestra vida. ¿Qué lugar ocupa nuestro esposo o esposa? (Filip. 1:10).",
        "items": [
          "Jehová. Nuestra amistad con Jehová ocupa el primer lugar en nuestra vida (Mat. 6:33; Mar. 12:30). Jamás seremos desleales a Jehová por complacer a nuestro esposo o esposa (Hech. 5:29; compare con Génesis 2:16, 17; 3:6).",
          "Nuestro esposo o esposa. Los dos somos \"una sola carne\". Por eso cuidamos de él o de ella con tanto cariño como de nosotros mismos (Gén. 2:24; Efes. 5:28, 29, 33).",
          "Otras personas y responsabilidades. Queremos atender a nuestros padres, familiares y hermanos espirituales y cumplir con nuestras responsabilidades en la congregación. Pero, aparte de Jehová, nada ni nadie debe estar por encima del bienestar y la felicidad de nuestro esposo o esposa (1 Tim. 5:8)."
        ]
      }
    },
    {
    ...
    },
    {
      ...
      "sidebar": {
        "title": "Ayudas para fortalecer su amistad",
        "intro": "La organización de Jehová prepara una gran variedad de información para ayudar a los matrimonios a fortalecer e incluso reconstruir su amistad. ¿Ha probado ya algunas de las sugerencias disponibles en los siguientes recursos?",
        "items": [
          "El folleto Su familia puede ser feliz",
          "La serie de videos \"Secretos para un matrimonio feliz\"",
          "Los artículos de la serie \"Ayuda para las familias\"",
          "La sección de jw.org \"El matrimonio y la familia\""
        ]
      }
    },
    {
  ...
  "reviewQuestions": [
    ...
    },
    {
      ...
      "commentSuggestion": "Yo podría comentar que pasar tiempo juntos y en actividades espirituales fortalece la amistad conyugal."
    },
    {
      ...
      "commentSuggestion": "Yo podría comentar que con amor, empeño y la ayuda de Jehová un matrimonio puede superar problemas graves."
    }
  ],
  "finalSong": "Canción 132 Ahora ya somos uno"
};
