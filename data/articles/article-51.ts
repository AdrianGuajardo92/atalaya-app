...
// ============================================
// TEXTOS BÍBLICOS DEL ARTÍCULO 51
// "Cómo planear una boda que honre a Jehová"
// ============================================
export const biblicalTexts51: Record<string, { reference: string; text: string }[]> = {
  "LEE Romanos 13:1, 2": [
...
// ============================================
// DATOS DEL ARTÍCULO 51
// ============================================
export const article51: ArticleData = {
  metadata: {
    articleNumber: 51,
    week: "23 Feb-1 Mar",
    month: "Diciembre",
  ...
  questions: [
    ...
    },
    {
      ...
      answer: [
        "Las leyes establecen ciertos **requisitos legales** que los novios deben cumplir para poder casarse.",
    ...
    },
    {
      ...
      paragraphs: [7],
      answer: [
        "Debe haber un ambiente que refleje **el fruto del espíritu de Dios**, no el espíritu del mundo.",
    ...
    },
    {
      ...
      paragraphs: [9],
      answer: [
        "Si planean que familiares o amigos les dediquen unas palabras, deben asegurarse de que todo sea **apropiado y animador**.",
    ...
    },
    {
      ...
      paragraphs: [12],
      answer: [
        "En el mundo de **Satanás**, las bodas suelen incluir costumbres relacionadas con **la religión falsa, el ocultismo y las supersticiones**.",
  ...
  paragraphs: [
    {
      ...
      summary: "**Jehová** desea que los novios **disfruten mucho el día de su boda** y que tengan un **matrimonio muy feliz** (Proverbios 5:18; Cantares 3:11)."
    },
    {
      number: 2,
      ...
      summary: "Es muy importante que la boda **honre a Jehová**. Los **principios bíblicos** del artículo ayudarán a los novios, y también a quienes **asistan** o den **consejos**."
    },
    {
      number: 3,
      content: "A la hora de organizar su boda, las parejas cristianas deben tomar en cuenta los principios que Jehová ha establecido en su Palabra. ¿Por qué? Porque Jehová es el Creador del matrimonio. De hecho, fue él quien casó a los dos primeros seres humanos, Adán y Eva (Gen. 1:28; 2:24). Así que para ustedes, los novios, el punto de vista de Dios debe ser lo más importante.",
      summary: "Las parejas deben tomar en cuenta **los principios de Jehová** porque él es **el Creador del matrimonio**. Fue él quien casó a **Adán y Eva** (Génesis 1:28; 2:24). **El punto de vista de Dios** debe ser lo más importante."
    },
    {
      number: 4,
      ...
      summary: "Jehová es nuestro **Padre celestial** y nuestro **mejor amigo** (Hebreos 12:9). Queremos **proteger nuestra amistad** con él y evitar que algo lo ofenda (Salmo 25:14). Por todo lo que ha hecho, **merece que lo honremos** en nuestra boda (Salmo 116:12)."
    },
    {
      number: 5,
      ...
      summary: "La Biblia **no contiene una lista de reglas** sobre cómo debe ser una boda. Hay un **abanico de posibilidades** según circunstancias, costumbres y gustos personales. Los cristianos también **respetamos las leyes locales** (Mateo 22:21). Si se guían por **los principios bíblicos**, su boda honrará a Jehová."
    },
    {
      number: 6,
      content: "En la mayoría de los países, las leyes establecen ciertos requisitos que los novios deben cumplir para poder casarse. Así que averiguen cuáles son los que aplican en el lugar donde ustedes viven. Si necesitan ayuda, pueden pedírsela a los ancianos.",
      summary: "Las leyes establecen **requisitos legales** que los novios deben cumplir para casarse. Deben **averiguar cuáles aplican** donde viven. Si necesitan ayuda, pueden **pedírsela a los ancianos**."
    },
    {
      number: 7,
      content: "Procuren que su boda refleje el fruto del espíritu de Dios, y no el espíritu del mundo (Gal. 5:19-26). Como el novio será el cabeza de la nueva familia, él es responsable de que la ceremonia sea una ocasión digna y alegre. ¿Qué factores contribuirán a lograrlo? Un discurso de boda basado en la Biblia que se presenta con amor, cariño y dignidad beneficia a los asistentes porque pueden ver que el matrimonio es un regalo de Dios y que la boda es una ocasión importante y seria. Por ese motivo, la mayoría de las parejas eligen que la ceremonia tenga lugar en un Salón del Reino, si es posible. Si una pareja desea usar un Salón del Reino, debe pedírselo por escrito al cuerpo de ancianos con bastante antelación.",
      summary: "La boda debe reflejar **el fruto del espíritu**, no el espíritu del mundo (Gálatas 5:19-26). El novio, como **cabeza de la nueva familia**, es responsable de que sea **digna y alegre**. Un **discurso basado en la Biblia** beneficia a los asistentes. La mayoría eligen celebrar en un **Salón del Reino**."
    },
    {
      number: 8,
      ...
      summary: "La fiesta no debe reflejar **el espíritu del mundo** ni ser como las **'fiestas descontroladas'** de Romanos 13:13. Si sirven **bebidas alcohólicas**, deben tomar medidas para que nadie beba de más. La **música** debe estar a un volumen que permita conversar, y deben **revisar las letras** de las canciones."
    },
    {
      number: 9,
      ...
      summary: "El entretenimiento debe ser **apropiado y animador** (Filipenses 4:8). Deben preguntarse: '**¿Honrará a Jehová?**'. Hay que evitar **comentarios indecentes o con connotaciones sexuales** (Efesios 5:3). Quienes participen deben **conocer los deseos de los novios** y respetarlos."
    },
    {
      number: 10,
      ...
      summary: "Jehová valora que sus siervos **lo honren a él** en vez de hacer **'ostentación'**. **Mike** (Noruega): 'No nos metimos en **deudas** y pudimos seguir con el **precursorado**'. **Tabitha** (India): 'Tuvimos **menos decisiones** y nos ahorramos un montón de **estrés**'."
    },
    {
      number: 11,
      content: "¿Ya han decidido que se van a poner? Sin duda, quieren lucir lo mejor posible. Incluso en tiempos bíblicos, el novio y la novia le prestaban mucha atención a su aspecto (Is. 61:10). Claro, la ropa que ustedes elijan tal vez sea más o menos diferente a la que se pondrían en otras ocasiones, pero de todos modos debe ser decente y apropiada (1 Tim. 2:9). No permitan que la ropa —o cualquier otra cosa material— se convierta en el aspecto más destacado de la boda (1 Ped. 3:3, 4).",
      summary: "En **tiempos bíblicos** también se prestaba atención al aspecto (Isaías 61:10). La ropa debe ser **decente y apropiada** (1 Timoteo 2:9). No deben permitir que la ropa o cosas materiales se conviertan en **el aspecto más destacado** de la boda (1 Pedro 3:3, 4)."
    },
    {
      number: 12,
      ...
      summary: "Las bodas del mundo incluyen costumbres de **la religión falsa, el ocultismo y las supersticiones**. Jehová advierte que debemos **mantenernos alejados** de cosas impuras (2 Corintios 6:14-17). Si tienen dudas, deben **investigar el origen** de las costumbres y buscar **los principios bíblicos**."
    },
    {
      number: 13,
      content: "¿Dónde ustedes viven existe la costumbre de que los invitados les hagan regalos a los novios? Es posible que el tipo de regalo que los invitados hagan dependa de su situación económica. Por supuesto, la Biblia anima a los cristianos a dar y dice que hacerlo nos hace felices (Prov. 11:25; Hech. 20:35). Ahora bien, los novios no quieren que los invitados sientan que están obligados a hacerles un regalo o que un obsequio sencillo no les parecería suficiente. Los siervos de Jehová nos esforzamos por ver los regalos como él los ve y agradecemos cualquier cosa que otros nos dan por amor y no por obligación (2 Cor. 9:7).",
      summary: "La Biblia anima a **dar** y dice que hacerlo nos hace **felices** (Proverbios 11:25; Hechos 20:35). Los novios no quieren que los invitados se sientan **obligados a regalar**. Los siervos de Jehová agradecemos lo que nos dan **por amor y no por obligación** (2 Corintios 9:7)."
    },
    {
      number: 14,
      ...
      summary: "Mantener la boda **sencilla** puede ser un reto. **Charlie** (Islas Salomón): les costó decidir **a quién invitar** porque en su cultura todos esperan ser invitados. **Tabitha** (India): tomó tiempo que sus padres aceptaran invitar solo a **100 personas**. **Sarah** (India): algunos la presionaban para una boda **más espectacular**."
    },
    {
      number: 15,
      ...
      summary: "Deben **orar con frecuencia** sobre todo lo relacionado con la boda (Filipenses 4:6, 7). Pueden pedirle a Jehová que los ayude a **tomar buenas decisiones** y **mantener la calma** (1 Pedro 5:7). **Tabitha**: 'Antes de hablar de nuestros planes siempre **hacíamos una oración**. Vimos cómo Jehová nos ayudaba a **mantener la paz**'."
    },
    {
      number: 16,
      content: "Organizar una boda requiere que la pareja tome muchas decisiones, como la fecha, el presupuesto, la lista de invitados, etc. Antes de tomar cada decisión, analicen juntos las opciones, los principios bíblicos aplicables y los consejos que tal vez les den otros cristianos maduros. Al expresar sus opiniones, sean amables, comprensivos y flexibles. Si familiares cercanos —como sus padres— les hacen peticiones razonables, traten de complacerlos. A fin de cuentas, para ellos también es una ocasión especial. Y, si no pueden concederles lo que les piden, explíquenles las razones con tacto y cariño (Col. 4:6). Ayudenlos a ver que su principal objetivo es disfrutar de un día muy feliz y honrar a Jehová.",
      summary: "Deben **analizar juntos** las opciones y los **principios bíblicos** antes de cada decisión. Al expresar opiniones, ser **amables, comprensivos y flexibles**. Si familiares hacen **peticiones razonables**, traten de complacerlos. Expliquen las razones con **tacto y cariño** (Colosenses 4:6)."
    },
    {
      number: 17,
      ...
      summary: "Si los padres **no son Testigos**, explicarles las decisiones será difícil pero deben hacerlo **con bondad**. **Santhosh** (India): sus familias querían **rituales del hinduismo**. Decidieron **complacerlos en asuntos** que no desagradarían a Jehová, como cambiar el menú."
    },
    {
      number: 18,
      ...
      summary: "Si **planifican con cuidado**, tendrán **menos estrés** (1 Corintios 14:40). **Wayne** (Taiwán): tuvieron una **reunión previa** con los ayudantes para **repasar los preparativos** y ensayar partes de la ceremonia. Deben **cumplir el horario** previsto por respeto a los invitados."
    },
    {
      number: 19,
      ...
      summary: "Ser **previsores** evita muchos problemas (Proverbios 22:3). Si asisten **familiares no Testigos**, explicarles cómo son las bodas con el artículo de **jw.org**. Pueden pedir a un hermano maduro que sea el **'director del banquete'** (Juan 2:8) para controlar que todo vaya **según lo planeado**."
    },
    {
      number: 20,
      ...
      summary: "La boda es **solo un día**, el primero de una **maravillosa vida sirviendo juntos a Jehová**. Debe ser una ocasión **digna y sencilla**. Si se **dejan guiar por Jehová**, recordarán su boda con una sonrisa: '**Me encantó, no cambiaría nada**' (Salmo 37:3, 4)."
    }
  ],
  reviewQuestions: [
    {
